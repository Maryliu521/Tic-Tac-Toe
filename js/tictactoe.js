...
function rollForTurn() {
    ...
    var txt1 = "";
	for (var i = 0; i < 2; i++) {
		// random whole number between 1 and 7
    ...
    for (i=0;i<xArray.length;i++) {
		...
		if (pOne == pTwo) { // rigging roll on tie to avoid bug in code. Need to address this later...
			txt1 = "Stop the game and restart it!"
			writeMsg(txt1);
			/*pOne = 1;
			pTwo = 2;*/
		}
    	...
    	setTimeout(function() {writeMsg(txt1);}, 1000); // this asks finish first functions then next one
    }
